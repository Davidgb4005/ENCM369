// lab03exE.c: ENCM 369 Winter 2026 Lab 3 Exercise E
...
int sum_of_sats(const int *a, int n, int max_mag)
{
    ...
    // for a, s1 for n, s2 for max_mag, s3 for result and s4 for i; 
...
int main(void)
{
    ...
    alpha = 3000;
    beta = sum_of_sats(aaa, 6, 9);
    gamma = sum_of_sats(bbb, 4, 250);
    alpha += sum_of_sats(ccc, 6, 3) + beta + gamma;

    // Here alpha should have a value of 3479.
